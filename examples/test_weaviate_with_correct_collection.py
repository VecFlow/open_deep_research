"""
Test script that uses the correct collection name for Weaviate.
This temporarily sets the WEAVIATE_COLLECTION_NAME environment variable.
"""
...
# Override the collection name to use Text_tables
...
async def test_search():
    """Test the Weaviate search with the correct collection."""
